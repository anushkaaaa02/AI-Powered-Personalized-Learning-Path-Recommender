/* ============================================================
   PATHWISE — CONTENT DATA
   Career paths, roadmaps, projects. Kept separate from logic
   so the recommendation engine and roadmap builder stay modular.
   ============================================================ */
...
const PWData = (() => {
  ...
  function totalTopics(pathId){
    return (ROADMAPS[pathId] || []).reduce((sum,p)=>sum+p.topics.length,0);
  }

  return { CAREER_PATHS, ROADMAPS, PROJECTS, ACHIEVEMENTS, totalTopics };
})();
